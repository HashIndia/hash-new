                  ...
                  <tbody>
                    {zones.map((zone, index) => (
                      <tr key={index} className="border-b border-border">
                        ...
                        <td className="py-4 px-4 text-muted-foreground">{zone.cities}</td>
              ...
              <CardContent className="p-8">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center py-3 border-b border-border">
                    <span className="text-muted-foreground">Orders below ₹999</span>
                    <span className="font-medium text-foreground">₹99</span>
                  </div>
                  <div className="flex justify-between items-center py-3 border-b border-border">
                    <span className="text-muted-foreground">Orders ₹999 & above</span>
