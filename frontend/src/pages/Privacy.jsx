            ...
            <CardContent className="p-8 md:p-12">
              <div className="prose prose-gray max-w-none">
                <motion.section className="mb-12" variants={itemVariants}>
                  <h2 className="text-2xl font-semibold text-black mb-6 pb-2 border-b border-black">1. Information We Collect</h2>
                ...
                <motion.section className="mb-12" variants={itemVariants}>
                  <h2 className="text-2xl font-semibold text-black mb-6 pb-2 border-b border-black">2. How We Use Your Information</h2>
                  <p className="text-black mb-4 leading-relaxed">
                ...
                <motion.section className="mb-12" variants={itemVariants}>
                  <h2 className="text-2xl font-semibold text-black mb-6 pb-2 border-b border-black">3. Information Sharing</h2>
                  <p className="text-black mb-4 leading-relaxed">
                ...
                <motion.section className="mb-12" variants={itemVariants}>
                  <h2 className="text-2xl font-semibold text-black mb-6 pb-2 border-b border-black">4. Business Operations</h2>
                  <p className="text-black mb-4 leading-relaxed">
                ...
                <motion.section className="mb-12" variants={itemVariants}>
                  <h2 className="text-2xl font-semibold text-black mb-6 pb-2 border-b border-black">5. Data Security</h2>
                  <p className="text-black mb-4 leading-relaxed">
                ...
                <motion.section className="mb-12" variants={itemVariants}>
                  <h2 className="text-2xl font-semibold text-black mb-6 pb-2 border-b border-black">6. Your Rights</h2>
                  <p className="text-black mb-4 leading-relaxed">
                ...
                <motion.section className="mb-12" variants={itemVariants}>
                  <h2 className="text-2xl font-semibold text-black mb-6 pb-2 border-b border-black">7. Cookies and Tracking</h2>
                  <p className="text-black mb-4 leading-relaxed">
                ...
                <motion.section className="mb-12" variants={itemVariants}>
                  <h2 className="text-2xl font-semibold text-black mb-6 pb-2 border-b border-black">8. Children's Privacy</h2>
                  <p className="text-black mb-4 leading-relaxed">
                ...
                <motion.section className="mb-8" variants={itemVariants}>
                  <h2 className="text-2xl font-semibold text-black mb-6 pb-2 border-b border-black">9. Contact Us</h2>
                  ...
                  <div className="bg-white border border-black p-6 rounded-lg">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-black">Email: privacy@hash.com</p>
