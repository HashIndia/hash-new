      ...
      <div className="bg-black text-white py-16">
        ...
        >
          <motion.div variants={itemVariants}>
            ...
            <h2 className="text-3xl md:text-4xl font-light mb-4">Terms of Service</h2>
            ...
            <CardContent className="p-8 md:p-12">
              <div className="prose prose-gray max-w-none">
                <motion.section className="mb-12" variants={itemVariants}>
                  <h2 className="text-2xl font-semibold text-black mb-6 pb-2 border-b border-gray-200">1. Acceptance of Terms</h2>
                ...
                <motion.section className="mb-12" variants={itemVariants}>
                  <h2 className="text-2xl font-semibold text-black mb-6 pb-2 border-b border-gray-200">2. Use License</h2>
                  <p className="text-gray-700 mb-4 leading-relaxed">
                ...
                <motion.section className="mb-12" variants={itemVariants}>
                  <h2 className="text-2xl font-semibold text-black mb-6 pb-2 border-b border-gray-200">3. Product Information</h2>
                  <p className="text-gray-700 mb-4 leading-relaxed">
                ...
                <motion.section className="mb-12" variants={itemVariants}>
                  <h2 className="text-2xl font-semibold text-black mb-6 pb-2 border-b border-gray-200">4. Orders and Payment</h2>
                  <p className="text-gray-700 mb-4 leading-relaxed">
                ...
                <motion.section className="mb-12" variants={itemVariants}>
                  <h2 className="text-2xl font-semibold text-black mb-6 pb-2 border-b border-gray-200">5. Shipping and Delivery</h2>
                  <p className="text-gray-700 mb-4 leading-relaxed">
                ...
                <motion.section className="mb-12" variants={itemVariants}>
                  <h2 className="text-2xl font-semibold text-black mb-6 pb-2 border-b border-gray-200">6. Returns and Exchanges</h2>
                  <p className="text-gray-700 mb-4 leading-relaxed">
                ...
                <motion.section className="mb-12" variants={itemVariants}>
                  <h2 className="text-2xl font-semibold text-black mb-6 pb-2 border-b border-gray-200">7. User Accounts</h2>
                  <p className="text-gray-700 mb-4 leading-relaxed">
                ...
                <motion.section className="mb-12" variants={itemVariants}>
                  <h2 className="text-2xl font-semibold text-black mb-6 pb-2 border-b border-gray-200">8. Prohibited Uses</h2>
                  <p className="text-gray-700 mb-4 leading-relaxed">
                ...
                <motion.section className="mb-12" variants={itemVariants}>
                  <h2 className="text-2xl font-semibold text-black mb-6 pb-2 border-b border-gray-200">9. Limitation of Liability</h2>
                  <p className="text-gray-700 mb-4 leading-relaxed">
                ...
                <motion.section className="mb-8" variants={itemVariants}>
                  <h2 className="text-2xl font-semibold text-black mb-6 pb-2 border-b border-gray-200">10. Contact Information</h2>
                  ...
                  <div className="bg-gray-50 border border-gray-200 p-6 rounded-lg">
                    ...
                    <div className="space-y-2">
                      <p className="text-gray-700">Email: legal@hash.com</p>
