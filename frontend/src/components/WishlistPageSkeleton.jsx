      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-4">
            <div className="w-8 h-8 bg-gradient-to-r from-hash-pink/30 to-hash-pink/20 rounded animate-pulse"></div>
            <div className="h-8 md:h-12 bg-gradient-to-r from-foreground/10 to-foreground/5 rounded-lg w-48 animate-pulse"></div>
          </div>
          <div className="h-5 bg-gradient-to-r from-muted-foreground/20 to-muted-foreground/10 rounded w-64 mx-auto animate-pulse"></div>
        </motion.div>
        ...
        >
          <div className="h-6 bg-gradient-to-r from-foreground/15 to-foreground/10 rounded w-40 mx-auto animate-pulse"></div>
        </motion.div>
              ...
              <Card className="group hover:shadow-xl transition-all duration-300 border-border bg-card h-full overflow-hidden">
                <CardContent className="p-0">
                  ...
                  <div className="aspect-square relative overflow-hidden">
                    <div className="w-full h-full bg-gradient-to-br from-foreground/10 to-foreground/5 animate-pulse"></div>
                    
                    {/* Heart Icon Skeleton */}
                    <div className="absolute top-3 right-3 w-8 h-8 bg-gradient-to-r from-hash-pink/30 to-hash-pink/20 rounded-full animate-pulse"></div>
                  ...
                  <div className="p-4 space-y-3">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="h-3 bg-gradient-to-r from-muted-foreground/20 to-muted-foreground/10 rounded w-2/3 animate-pulse"></div>
                    </div>
                    
                    {/* Price and Category */}
                    <div className="flex justify-between items-center">
                      <div className="h-6 bg-gradient-to-r from-hash-purple/30 to-hash-purple/20 rounded w-16 animate-pulse"></div>
                      <div className="h-5 bg-gradient-to-r from-hash-purple/10 to-hash-purple/5 rounded-full w-20 animate-pulse"></div>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                      <div className="flex gap-1">
                        {[1, 2, 3, 4, 5].map((star) => (
                          <div key={star} className="w-4 h-4 bg-gradient-to-r from-hash-yellow/30 to-hash-yellow/20 rounded animate-pulse"></div>
                        ))}
                      </div>
                    ...
                    <div className="flex gap-2 pt-2">
                      {/* Add to Cart Button */}
                      <div className="flex-1 h-9 bg-gradient-to-r from-hash-purple/20 to-hash-purple/10 rounded-lg animate-pulse"></div>
                      
                      {/* Remove Button */}
                      <div className="w-9 h-9 bg-gradient-to-r from-destructive/20 to-destructive/10 rounded-lg animate-pulse"></div>
                    </div>
                  </div>
                </CardContent>
              </Card>
